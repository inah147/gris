...
def get_context(context):
	if frappe.session.user == "Guest":
		frappe.local.flags.redirect_location = "/login?redirect-to=/gestao_adultos/entrevista_competencias"
		raise frappe.Redirect

	enrich_context(context, "/gestao_adultos/entrevista_competencias")
