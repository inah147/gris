...
doc_events = {
	...
	# Hooks em `Comment`, filtrados por `reference_doctype` dentro do handler,
	# cobrem os tres jeitos de comentar numa Sugestao ou Problema (portal, MCP e
	# Desk) sem duplicar o aviso nem a baixa da pendencia em cada endpoint de
	# escrita.
	"Comment": {
		"after_insert": [
			"gris.api.sugestoes.notificacoes.on_comentario_criado",
			"gris.api.sugestoes.portal.limpar_esclarecimento_ao_responder",
		],
	},
}
