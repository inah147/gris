...
function enforce_guardiao_exclusivity(frm, changed_field) {
	if (
		changed_field === "guardiao_legal_responsavel_1" &&
		frm.doc.guardiao_legal_responsavel_1 === 1
	) {
	...
	if (
		changed_field === "guardiao_legal_responsavel_2" &&
		frm.doc.guardiao_legal_responsavel_2 === 1
	) {
