...
> Não usar fluxo de handoff irrestrito entre agentes neste projeto.
> Subagentes são permitidos de forma **controlada** quando a própria skill exigir papéis especializados para criação, avaliação ou comparação de resultados (ex.: `gris-skill-creator`).
