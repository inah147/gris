...
def get_context(context):
	if frappe.session.user == "Guest":
		frappe.local.flags.redirect_location = "/login?redirect-to=/projetos"
		raise frappe.Redirect

	if not user_has_access("/projetos"):
	...
	context.active_link = "/projetos"
	enrich_context(context, "/projetos")
	return context
