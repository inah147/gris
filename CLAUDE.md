...
| Rodar os testes e o lint do CI numa sessão do Claude Code na web (`bench-gris run-tests --app gris` e `gris-lint`) | [.claude/hooks/session-start.sh](.claude/hooks/session-start.sh) |
